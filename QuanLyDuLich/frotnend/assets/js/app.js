...
registerRoute('tour-edit', async (params) => {
    ...
    if (params.id) {
        ...
        document.getElementById('gia').value = tour.gia;
        document.getElementById('thoiGian').value = tour.thoiGian;
        document.getElementById('maDiemDen').value = tour.maDiemDen;
        title.textContent = 'Sửa Tour';
    } else {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        formData.append('maDiemDen', document.getElementById('maDiemDen').value);
